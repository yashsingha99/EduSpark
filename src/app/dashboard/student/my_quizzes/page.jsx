...
function Page() {
  ...
  const handleJoinClick = () => {
    if (code?.length !== 6) {
      ...
      // router.push({
      //   pathname: "/dashboard/student/my_quizzes/joinQuiz",
      //   query: { code },  
      // });
      // router.push( "/dashboard/student/my_quizzes/joinQuiz" );
      router.push(`/dashboard/student/my_quizzes/joinQuiz?code=${code}`);
