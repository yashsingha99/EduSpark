...
import { useAppContext } from "../../../../../hooks/LocalStorage";
import { generateQuiz } from "../../../../../API_FROM_EXPRESS/Quiz";
import CloseIcon from "@mui/icons-material/Close";
import ContentCopyIcon from "@mui/icons-material/ContentCopy";

function ConfirmationAndDetails({ setMethod, questionStats }) {
 ...
 let user= JSON.parse(localStorage.getItem("user"))
  ...
  const { questions, setQuestions } = questionStats
